...
public abstract class AbstractUserServiceTests {
	...
	public void testUsers() {
		...
		Assert.assertEquals(List.of(CrmAsserts.ORG_ADMIN, CrmAsserts.CRM_ADMIN), u1.getRoleIds());
		...
		Assert.assertEquals(List.of(CrmAsserts.SYS_ADMIN), u2.getRoleIds());
		...
		Assert.assertEquals(List.of(CrmAsserts.ORG_ADMIN, CrmAsserts.CRM_ADMIN, CrmAsserts.SYS_ADMIN), u3.getRoleIds());
		...
		Assert.assertEquals(adam.getPersonId(), u1.getPersonId());
		Assert.assertEquals(List.of(CrmAsserts.ORG_ADMIN), u1.getRoleIds());
		Assert.assertEquals(Status.ACTIVE, u1.getStatus());
		Assert.assertEquals("adam21", u1.getUsername());
		Assert.assertEquals(u1, crm.findUser(u1.getUserId()));
		...
		Assert.assertEquals(List.of(CrmAsserts.ORG_ADMIN, CrmAsserts.CRM_ADMIN, CrmAsserts.SYS_ADMIN), u1.getRoleIds());
		Assert.assertEquals(u1, crm.findUser(u1.getUserId()));
