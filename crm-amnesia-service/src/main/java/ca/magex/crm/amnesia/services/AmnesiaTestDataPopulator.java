...
public class AmnesiaTestDataPopulator {
	...
	public static SecuredCrmServices populate(SecuredCrmServices service) {
		...
		LocationDetails jokerMain = service.createLocation(gotham.getOrganizationId(), "Joker Nest", "JOKERNEST", new MailingAddress("234 Main Street", "Gotham", "Ontario", service.findCountryByCode("CA"), "K1K4R4"));
		...
		LocationDetails shieldMain = service.createLocation(shield.getOrganizationId(), "Head Quarters", "HQ", new MailingAddress("99 Blue Jays Way", "Gotham", "Ontario", service.findCountryByCode("CA"), "J2N8A4"));
