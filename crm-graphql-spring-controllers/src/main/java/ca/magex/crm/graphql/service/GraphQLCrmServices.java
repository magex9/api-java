...
public class GraphQLCrmServices {
	...
	private RuntimeWiring buildRuntimeWiring() {
		...
		return RuntimeWiring.newRuntimeWiring()
				...
				.type("Mutation", typeWiring -> typeWiring.dataFetcher("enableUser", userDataFetcher.enableUser()))
				.type("Mutation", typeWiring -> typeWiring.dataFetcher("disableUser", userDataFetcher.disableUser()))
				...
				.type("Mutation", typeWiring -> typeWiring.dataFetcher("enableOption", optionDataFetcher.enableOption()))
				.type("Mutation", typeWiring -> typeWiring.dataFetcher("disableOption", optionDataFetcher.disableOption()))
