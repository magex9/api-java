...
public class GraphQLOptionServiceTests extends AbstractOptionServiceTests {
	...
	public void setup() {	
		...
		remoteServicesAdapter = new CrmServicesAdapter(crm, new GraphQLOptionService(client), crm, crm, crm, crm);
	}
}