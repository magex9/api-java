...
public class MongoOptionRepositoryTests {
	...
	public void testFindOrganization() {
		...
		System.out.println(repo.findOrganizationSummary(new OrganizationsFilter(), new Paging(2, 2, Sort.by("displayName"))));
	}
...
//	@Test
	public void insertOrganization() {
		...
		OrganizationDetails orgDetails = new OrganizationDetails(
				new OrganizationIdentifier("ABC"),
				Status.ACTIVE,
				"ABC Corp",
				new LocationIdentifier("HQ"),
				new PersonIdentifier("ADMIN"),
				List.of(new AuthenticationGroupIdentifier("ORG"), new AuthenticationGroupIdentifier("CRM")),
