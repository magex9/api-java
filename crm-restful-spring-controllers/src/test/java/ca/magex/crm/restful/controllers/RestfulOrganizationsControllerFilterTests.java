...
public class RestfulOrganizationsControllerFilterTests extends AbstractControllerTests {
	...
	public void testOrganizationFilterDefaultRoot() throws Exception {
		...
		assertEquals(List.of("@context", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(0).keys());
		...
		assertEquals(List.of("@context", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(1).keys());
		...
		assertEquals(List.of("@context", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(2).keys());
		...
		assertEquals(List.of("@context", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(3).keys());
	...
	public void testOrganizationFilterDefaultEnglish() throws Exception {
		...
		assertEquals(false, json.getBoolean("hasPrevious"));
		assertEquals(4, json.getArray("content").size());
		assertEquals(List.of("organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(0).keys());
		...
		assertEquals("A new org 1", json.getArray("content").getObject(0).getString("displayName"));
		assertEquals(List.of("organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(1).keys());
		...
		assertEquals("A néw org 2", json.getArray("content").getObject(1).getString("displayName"));
		assertEquals(List.of("organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(2).keys());
		...
		assertEquals("An inactive org 3", json.getArray("content").getObject(2).getString("displayName"));
		assertEquals(List.of("organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(3).keys());
