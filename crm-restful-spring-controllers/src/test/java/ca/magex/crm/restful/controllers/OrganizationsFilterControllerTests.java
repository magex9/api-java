...
public class OrganizationsFilterControllerTests extends AbstractControllerTests {
	...
	public void testOrganizationFilterDefaultRoot() throws Exception {
		...
		assertEquals(List.of("@context", "organizationId", "status", "displayName"), json.getArray("content").getObject(0).keys());
		...
		assertEquals(List.of("@context", "organizationId", "status", "displayName"), json.getArray("content").getObject(1).keys());
		...
		assertEquals(List.of("@context", "organizationId", "status", "displayName"), json.getArray("content").getObject(2).keys());
		...
		assertEquals(List.of("@context", "organizationId", "status", "displayName"), json.getArray("content").getObject(3).keys());
	...
	public void testOrganizationFilterDefaultEnglish() throws Exception {
		...
		assertEquals("A néw org 2", json.getArray("content").getObject(1).getString("displayName"));
		assertEquals(List.of("organizationId", "status", "displayName"), json.getArray("content").getObject(2).keys());
		...
		assertEquals("An inactive org 3", json.getArray("content").getObject(2).getString("displayName"));
		assertEquals(List.of("organizationId", "status", "displayName"), json.getArray("content").getObject(3).keys());
