...
public class LocationsFilterControllerTests extends AbstractControllerTests {
	...
	public void testLocationsFilterDefaultRoot() throws Exception {
		...
		assertEquals(List.of("@context", "locationId", "organizationId", "status", "reference", "displayName", "lastModified"), json.getArray("content").getObject(0).keys());
		...
		assertEquals(List.of("@context", "locationId", "organizationId", "status", "reference", "displayName", "lastModified"), json.getArray("content").getObject(1).keys());
		...
		assertEquals(List.of("@context", "locationId", "organizationId", "status", "reference", "displayName", "lastModified"), json.getArray("content").getObject(2).keys());
	...
	public void testLocationsFilterDefaultEnglish() throws Exception {
		...
		assertEquals(false, json.getBoolean("hasPrevious"));
		assertEquals(9, json.getArray("content").size());
		assertEquals(List.of("locationId", "organizationId", "status", "reference", "displayName", "lastModified"), json.getArray("content").getObject(0).keys());
		...
		assertEquals("AMERICAN", json.getArray("content").getObject(0).getString("reference"));
		assertEquals("American Location", json.getArray("content").getObject(0).getString("displayName"));
		assertEquals(List.of("locationId", "organizationId", "status", "reference", "displayName", "lastModified"), json.getArray("content").getObject(1).keys());
		...
		assertEquals("BRITISH", json.getArray("content").getObject(1).getString("reference"));
		assertEquals("British Location", json.getArray("content").getObject(1).getString("displayName"));
		assertEquals(List.of("locationId", "organizationId", "status", "reference", "displayName", "lastModified"), json.getArray("content").getObject(2).keys());
	...
	public void testFilterByActiveDesc() throws Exception {
		...
		assertEquals(List.of("locationId", "organizationId", "status", "reference", "displayName", "lastModified"), json.getArray("content").getObject(3).keys());
