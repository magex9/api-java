...
public class UsersFilterControllerTests extends AbstractControllerTests {
	...
	public void setup() {
		...
		crm.disablePerson(crm.findUser(elaineId).getPersonId());
	...
	public void testOrganizationFilterDefaultRoot() throws Exception {
		...
		assertEquals(crm.findUser(adamId).getOrganizationId().getCode(), json.getArray("content").getObject(0).getString("organizationId"));
		assertEquals(crm.findUser(adamId).getPersonId().getCode(), json.getArray("content").getObject(0).getString("personId"));
		...
		assertEquals(crm.findUser(systemUserId).getOrganizationId().getCode(), json.getArray("content").getObject(1).getString("organizationId"));
		assertEquals(crm.findUser(systemUserId).getPersonId().getCode(), json.getArray("content").getObject(1).getString("personId"));
		...
		assertEquals(crm.findUser(bobId).getOrganizationId().getCode(), json.getArray("content").getObject(2).getString("organizationId"));
		assertEquals(crm.findUser(bobId).getPersonId().getCode(), json.getArray("content").getObject(2).getString("personId"));
		...
		assertEquals(crm.findUser(chloeId).getOrganizationId().getCode(), json.getArray("content").getObject(3).getString("organizationId"));
		assertEquals(crm.findUser(chloeId).getPersonId().getCode(), json.getArray("content").getObject(3).getString("personId"));
		...
		assertEquals(crm.findUser(danId).getOrganizationId().getCode(), json.getArray("content").getObject(4).getString("organizationId"));
		assertEquals(crm.findUser(danId).getPersonId().getCode(), json.getArray("content").getObject(4).getString("personId"));
		...
		assertEquals(crm.findUser(elaineId).getOrganizationId().getCode(), json.getArray("content").getObject(5).getString("organizationId"));
		assertEquals(crm.findUser(elaineId).getPersonId().getCode(), json.getArray("content").getObject(5).getString("personId"));
		...
		assertEquals(crm.findUser(francoisId).getOrganizationId().getCode(), json.getArray("content").getObject(6).getString("organizationId"));
		assertEquals(crm.findUser(francoisId).getPersonId().getCode(), json.getArray("content").getObject(6).getString("personId"));
	...
	public void testFilterByUsername() throws Exception {
		...
		assertEquals(crm.findUser(chloeId).getOrganizationId().getCode(), json.getArray("content").getObject(0).getString("organizationId"));
		assertEquals(crm.findUser(chloeId).getPersonId().getCode(), json.getArray("content").getObject(0).getString("personId"));
		...
		assertEquals(crm.findUser(elaineId).getOrganizationId().getCode(), json.getArray("content").getObject(1).getString("organizationId"));
		assertEquals(crm.findUser(elaineId).getPersonId().getCode(), json.getArray("content").getObject(1).getString("personId"));
	...
	public void testFilterByRole() throws Exception {
		...
		assertEquals(crm.findUser(danId).getOrganizationId().getCode(), json.getArray("content").getObject(1).getString("organizationId"));
		assertEquals(crm.findUser(danId).getPersonId().getCode(), json.getArray("content").getObject(1).getString("personId"));
		...
		assertEquals(crm.findUser(francoisId).getOrganizationId().getCode(), json.getArray("content").getObject(2).getString("organizationId"));
		assertEquals(crm.findUser(francoisId).getPersonId().getCode(), json.getArray("content").getObject(2).getString("personId"));
	...
	public void testFilterByPersonId() throws Exception {
		User user = crm.findUser(francoisId);
	...
	public void testFilterByOrgId() throws Exception {
		...
		assertEquals(crm.findUser(danId).getOrganizationId().getCode(), json.getArray("content").getObject(0).getString("organizationId"));
		assertEquals(crm.findUser(danId).getPersonId().getCode(), json.getArray("content").getObject(0).getString("personId"));
	...
	public void testFilterByInactifDesc() throws Exception {
		...
		assertEquals(crm.findUser(bobId).getOrganizationId().getCode(), json.getArray("content").getObject(0).getString("organizationId"));
		assertEquals(crm.findUser(bobId).getPersonId().getCode(), json.getArray("content").getObject(0).getString("personId"));
