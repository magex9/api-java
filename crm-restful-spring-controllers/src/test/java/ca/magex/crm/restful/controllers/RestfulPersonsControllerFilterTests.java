...
public class RestfulPersonsControllerFilterTests extends AbstractControllerTests {
	...
	public void testPersonsFilterDefaultRoot() throws Exception {
		...
		assertEquals(List.of("@context", "personId", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(0).keys());
		...
		assertEquals(List.of("@context", "personId", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(1).keys());
		...
		assertEquals(List.of("@context", "personId", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(2).keys());
		...
		assertEquals(List.of("@context", "personId", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(3).keys());
		...
		assertEquals(List.of("@context", "personId", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(4).keys());
		...
		assertEquals(List.of("@context", "personId", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(5).keys());
		...
		assertEquals(List.of("@context", "personId", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(6).keys());
	...
	public void testPersonsFilterDefaultEnglish() throws Exception {
		...
		assertEquals(false, json.getBoolean("hasPrevious"));
		assertEquals(7, json.getArray("content").size());
		assertEquals(List.of("personId", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(0).keys());
		...
		assertEquals("Admin", json.getArray("content").getObject(0).getString("displayName"));
		assertEquals(List.of("personId", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(1).keys());
		...
		assertEquals("Anderson, Adam A", json.getArray("content").getObject(1).getString("displayName"));
		assertEquals(List.of("personId", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(2).keys());
		...
		assertEquals("LaRue, Chloé", json.getArray("content").getObject(2).getString("displayName"));
		assertEquals(List.of("personId", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(3).keys());
		...
		assertEquals("Mátyás, François", json.getArray("content").getObject(3).getString("displayName"));
		assertEquals(List.of("personId", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(4).keys());
		...
		assertEquals("McKay, Elaine M", json.getArray("content").getObject(4).getString("displayName"));
		assertEquals(List.of("personId", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(5).keys());
		...
		assertEquals("O'Sullivan, Daniel D", json.getArray("content").getObject(5).getString("displayName"));
		assertEquals(List.of("personId", "organizationId", "status", "displayName", "lastModified", "actions"), json.getArray("content").getObject(6).keys());
