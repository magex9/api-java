package ca.magex.crm.slf4j.services;
...
public class CrmLocationServiceSlf4jDecorator implements CrmLocationService {
	...
	@Override
	public LocationDetails prototypeLocation(Identifier organizationId, String displayName, String reference, MailingAddress address) {
		if (logger.isTraceEnabled()) {
			long start = System.nanoTime();
			try {
				logger.trace("Calling prototypeLocation(" + organizationId + ", " + displayName + ", " + reference + ", " + address + ")");
				LocationDetails result = delegate.prototypeLocation(organizationId, displayName, reference, address);
				logger.trace("Executed prototypeLocation(" + organizationId + ", " + displayName + ", " + reference + ", " + address + ") in " + Duration.ofNanos(System.nanoTime() - start) + " (" + result.getClass() + ": " + result + ").");
				return result;
			}
			catch (Exception e) {
				logger.trace("Exception on prototypeLocation(" + organizationId + ", " + displayName + ", " + reference + ", " + address + ") in " + Duration.ofNanos(System.nanoTime() - start) + " (" + e.getClass() + ": " + e.getMessage() + ").");
				throw e;
			}
		}
			...
			long start = System.nanoTime();
			try {
				logger.debug("Calling prototypeLocation(" + organizationId + ", " + displayName + ", " + reference + ", " + address + ")");
				LocationDetails result = delegate.prototypeLocation(organizationId, displayName, reference, address);
				logger.debug("Executed prototypeLocation(" + organizationId + ", " + displayName + ", " + reference + ", " + address + ") in " + Duration.ofNanos(System.nanoTime() - start) + ".");
				return result;
			}
			catch (Exception e) {
				logger.debug("Exception on prototypeLocation(" + organizationId + ", " + displayName + ", " + reference + ", " + address + ") in " + Duration.ofNanos(System.nanoTime() - start) + " (" + e.getClass() + ": " + e.getMessage() + ").");
				throw e;
			}
		}
		else if (logger.isInfoEnabled()) {
			logger.info("Calling prototypeLocation(" + organizationId + ", " + displayName + ", " + reference + ", " + address + ")");
			return delegate.prototypeLocation(organizationId, displayName, reference, address);
		}
		else {
			return delegate.prototypeLocation(organizationId, displayName, reference, address);
		}
	...
	@Override
	public Page<LocationSummary> findActiveLocationSummariesForOrg(Identifier organizationId) {
		if (logger.isTraceEnabled()) {
			long start = System.nanoTime();
			try {
				logger.trace("Calling findActiveLocationSummariesForOrg(" + organizationId + ")");
				Page<LocationSummary> result = delegate.findActiveLocationSummariesForOrg(organizationId);
