...
public class CrmPolicies implements ca.magex.crm.api.policies.CrmLookupPolicy, ca.magex.crm.api.policies.CrmPermissionPolicy, ca.magex.crm.api.policies.CrmOrganizationPolicy, ca.magex.crm.api.policies.CrmLocationPolicy, ca.magex.crm.api.policies.CrmPersonPolicy, ca.magex.crm.api.policies.CrmUserPolicy {
	...
	public CrmPolicies(
			ca.magex.crm.api.policies.CrmLookupPolicy crmLookupPolicy,
			ca.magex.crm.api.policies.CrmPermissionPolicy crmPermissionPolicy,
			ca.magex.crm.api.policies.CrmOrganizationPolicy crmOrganizationPolicy,
			ca.magex.crm.api.policies.CrmLocationPolicy crmLocationPolicy,
			ca.magex.crm.api.policies.CrmPersonPolicy crmPersonPolicy,
			ca.magex.crm.api.policies.CrmUserPolicy crmUserPolicy) {
