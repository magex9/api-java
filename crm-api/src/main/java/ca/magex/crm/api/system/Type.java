...
public enum Type {
	...
	AUTHENTICATION_GROUP("AUTHENTICATION_GROUPS", "Authentication Groups", "Groupes d'authentification", null, true, true, false), 
	AUTHENTICATION_ROLE("AUTHENTICATION_ROLES", "Authentication Roles", "Rôles d'authentification", AUTHENTICATION_GROUP, false, true, false),
